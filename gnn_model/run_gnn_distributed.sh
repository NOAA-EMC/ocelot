...
srun --export=ALL --kill-on-bad-exit=1 --cpu-bind=cores python /scratch3/NCEPDEV/da/Ronald.McLaren/shared/ocelot/src/ocelot/gnn_model/train_gnn.py --parallelization_strategy=domain --domain_halo_hops=1 --num_nodes=4 --max_epochs=4
