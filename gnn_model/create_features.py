...
@timing_decorator
def organize_bins_times(z, start_date, end_date, selected_satellite_id):
    """
...
def extract_features(z, data_summary):
    ...
    Returns:
        dict: Updated data_summary with additional keys:
            ...
            - 'target_features_final': Normalized target features including latitude, longitude, and brightness
            temperatures.
