...
def get_rotation_matrices_to_local_coordinates(
    ...
    if rotate_longitude and rotate_latitude:
        ...
        # point is at x=0 we can simply apply the polar rotation around the y
        # axis.
        ...
        return transform_.Rotation.from_euler(
            "z", azimuthal_rotation).as_matrix()
        ...
        return transform_.Rotation.from_euler("zyz", np_.stack(
