...
import zarr
from ocelot.graphcast.graphcast_aux import _get_max_edge_distance
from ocelot.graphcast import grid_mesh_connectivity as gc_gm
from ocelot.graphcast import icosahedral_mesh as gc_im
from ocelot.graphcast import model_utils as gc_mu
...
def main():
    ...
    grid_lat = np.array(
        fields_group["latitude"], dtype=DEFAULT_DTYPE
    )[:1000]  # (num_lat,)
    grid_lon = np.array(
