...
def main():
    ...
    #plot1.add_colorbar(label='Air Pressure Quality', orientation='horizontal', aspect=50)  # orig plots quality 
    plot1.add_colorbar(label='stationElevation', orientation='horizontal', aspect=50)  # plots values
    ...
    plt.savefig('stationElevation.png')
