...
BUFR_TANK_YAML = '/scratch3/NCEPDEV/da/Nicholas.Esposito/ocelot/source/ocelot/data_prep/configs/ursa.yaml'
...
MAPPING_FILE_DIR = '/scratch3/NCEPDEV/da/Nicholas.Esposito/ocelot/source/ocelot/data_prep/mapping'

OUTPUT_PATH = '/scratch3/NCEPDEV/da/Nicholas.Esposito/ocelot/data/dev'

BUFR_TABLE_DIR = '/scratch3/NCEPDEV/da/Nicholas.Esposito/src/NCEPLIBS-bufr/tables'
