...
python3 -m pip install torch_scatter -f https://data.pyg.org/whl/torch-2.5.1+cu124.html
python3 -m pip install torch-geometric==2.6.1
python3 -m pip install lightning==2.5.1
python3 -m pip install scikit-learn==1.6.1
python3 -m pip install matplotlib==3.10.3
python3 -m pip install psutil==5.9.8
python3 -m pip install trimesh==4.6.10
python3 -m pip install zarr==2.18.0
